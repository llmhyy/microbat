package microbat.evaluation.junit; // TODO: This is for backward compatibility. Ideally the package should not have "junit" inside it, since it also handles testng currently
