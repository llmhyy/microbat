...
public class StatementConstraintS3Test extends ConstraintTest {

    @Test
    public void testConstructionWithNullNode() {
        assertThrows(NullPointerException.class, () -> new StatementConstraintS3(null));
    }
    ...
    public void testConstructorWithInvalidPropbability() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new StatementConstraintS3(this.node, -1.0d));
    }

    @Test
    public void test0R0W0C() {
        assertThrows(WrongConstraintConditionException.class, () -> new StatementConstraintS3(this.node));
    }
    ...
    public void test1R1W0C() {
        this.node.addReadVariable(this.readVar1);
        this.node.addWrittenVariable(this.writeVar1);
        Constraint constraint = new StatementConstraintS3(this.node);
        ...
        Factor expectedFactor = new Factor("SS3_2", array, variables);
    ...
    public void test2R2W1C() {
        ...
        array.set(1 - this.propagationProbability, new int[] {1, 1, 0, 0, 1, 1});
        array.set(1 - this.propagationProbability, new int[] {1, 1, 0, 1, 1, 1});
        array.set(1 - this.propagationProbability, new int[] {1, 1, 1, 0, 1, 1});
