...
public class StatementConstraintS6Test extends ConstraintTest {
    @Test
    public void testConstructionWithNullNode() {
        assertThrows(NullPointerException.class, () -> new StatementConstraintS6(null));
    }
    ...
    public void test0R0W1C() {
        ...
        Factor expectedFactor = new Factor("SS6_2", array, variables);
