...
public class VariableConstraintA3Test extends ConstraintTest {
    ...
    public void testConstructionWithNullNode() {
        assertThrows(NullPointerException.class, () -> new VariableConstraintA3(null));
    }
    ...
    public void test0R1W1C() {
        this.node.addWrittenVariable(this.writeVar1);
        this.node.setControlDominator(this.controlDom);
        Constraint constraint = new VariableConstraintA3(this.node);
        ...
        Factor expectedFactor = new Factor("VA3_2", array, variables);
