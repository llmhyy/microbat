...
public class StatementConstraintS5Test extends ConstraintTest {
    
    @Test
    public void testConstructionWithNullNode() {
        assertThrows(NullPointerException.class,
                () -> new StatementConstraintS5(null, this.readVar1));
    }
    ...
    public void testConstructorWithInvalidPropbability() {
        ...
        assertThrows(IllegalArgumentException.class,
                () -> new StatementConstraintS5(this.node, this.readVar1, -1.0d));
    }
    ...
    public void testConstructorWithInvalidVariable() {
        ...
        assertThrows(WrongConstraintConditionException.class,
                () -> new StatementConstraintS5(this.node, this.writeVar1));
    }

    @Test
    public void test0R0W0C() {
        assertThrows(WrongConstraintConditionException.class,
                () -> new StatementConstraintS5(this.node, this.readVar1));
    }
    ...
    public void test1R0W0C() {
        this.node.addReadVariable(this.readVar1);
        Constraint constraint = new StatementConstraintS5(this.node, this.readVar1);
