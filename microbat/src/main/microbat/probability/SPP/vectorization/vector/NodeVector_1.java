 ...
 * @author David
 */
public class NodeVector_1 extends Vector {
	...
	public static final int DIMENSION = OperationVector.DIMENSION + 
										VariableVector.DIMENSION * NodeVector_1.NUM_REF_VARS + 
										VariableVector.DIMENSION +
										EnvironmentVector.DIMENSION + 
										FunctionVector.DIMENSION * NodeVector_1.NUM_FUNCS;
	...
	public NodeVector_1() {
		...
		this.refVarVectors = new VariableVector[NodeVector_1.NUM_REF_VARS];
		...
		this.funcVectors = new FunctionVector[NodeVector_1.NUM_FUNCS];
		...
		if (this.vector.length != NodeVector_1.DIMENSION) {
	 ...
	 * @param backward
	 */
	public NodeVector_1(final TraceNode node, final VarValue targetVar, final boolean backward) {
		...
		this.refVarVectors = VariableVector.constructVarVectors(
			...
			NodeVector_1.NUM_REF_VARS);
		this.targetVarVector = new VariableVector(targetVar);
		this.envVector = new EnvironmentVector(node);
		this.funcVectors = FunctionVector.constructFuncVectors(node, NodeVector_1.NUM_FUNCS);
