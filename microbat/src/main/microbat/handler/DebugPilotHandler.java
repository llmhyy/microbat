...
//		
//		public OmissionState(DebugPilotFiniteStateMachine stateMachine, final FeedbackPath_ path, final TraceNode startNode, final TraceNode endNode, final UserFeedback prevUserFeedback, final Trace trace) {
//			super(stateMachine);
...
//
//		public ControlOmissionState(DebugPilotFiniteStateMachine stateMachine, FeedbackPath_ path, TraceNode startNode,
...
//
//		public DataOmissionState(DebugPilotFiniteStateMachine stateMachine, FeedbackPath_ path, TraceNode startNode,
//				TraceNode endNode, UserFeedback prevUserFeedback, Trace trace) {
//			super(stateMachine, path, startNode, endNode, prevUserFeedback, trace);
//		}
//
