...
public class InstmInstructions {
	...
	public static List<InstructionInfo> getInstrumentationList(InstructionList insnList, Method method, String className) {
