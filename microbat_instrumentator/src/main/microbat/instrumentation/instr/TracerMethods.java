...
public enum TracerMethods {
	AFTER_INVOKE(true, "microbat/instrumentation/runtime/IExecutionTracer", "_afterInvoke", "(Ljava/lang/String;I)V", 3),
	...
	HIT_METHOD_END(true, "microbat/instrumentation/runtime/IExecutionTracer", "_hitMethodEnd", "(I)V", 2),
